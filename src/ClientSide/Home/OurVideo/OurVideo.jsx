      ...
      <div className="  ">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center py-[156px] xs:py-[156px] xl:py-[156px] 2xl:py-[156px] lg:py-[156px] md:py-[156px] ">
            <h1
              className="text-white font-helvetica font-bold text-[20px] leading-[30px] px-[150px] xs:text-[20px] xs:leading-[30px]  xl:text-[48px] xl:leading-[57.6px]  2xl:text-[48px] 2xl:leading-[57.6px] 
            lg:text-[35px] lg:leading-[45px]   md:text-[30px] md:leading-[45px] "
            >
              Our <span className="text-[#F6941E]">Video</span>
            </h1>
            <p
              className="text-white/[.8] font-helvetica font-bold mt-4 xl:text-[16px] xl:leading-[24px]   xl:px-[350px] 2xl:text-[16px] 2xl:leading-[24px]   2xl:px-[432px] lg:text-[16px] lg:leading-[24px]   lg:px-[180px]
            md:text-[16px] md:leading-[24px]   md:px-[100px]  text-[12px] leading-[20px]   px-[20px]
             xs:text-[12px] xs:leading-[20px]   xs:px-[20px]"
            >
