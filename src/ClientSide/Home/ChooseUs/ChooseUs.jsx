      ...
      <div className="  ">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center py-[156px] xs:py-[156px] xl:py-[156px] 2xl:py-[156px] lg:py-[156px] md:py-[156px] px-[16px] xs:px-[16px]">
            ...
            lg:text-[35px] xxs:text-[25px] xxs:leading-[30px] lg:leading-[45px] lg:px-[200px]  md:text-[30px] md:leading-[45px] md:px-[150px]"
            >
              Choose from 11+ University and College Scholarships
            </h1>
            <p
              className="text-white/[.8]  font-helvetica font-bold mt-4 text-[14px] px-[16px] leading-[21px]  xs:px-[16px] xxs:px-[10px] xxs:text-[12px] xxs:leading-[21px]  xs:text-[14px] xs:leading-[21px] xl:text-[16px] xl:leading-[24px]   xl:px-[449px] 2xl:text-[16px] 2xl:leading-[24px]   2xl:px-[449px] lg:text-[16px] lg:leading-[24px]   lg:px-[180px]
            md:text-[16px] md:leading-[24px]   md:px-[100px]"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
              tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
            </p>
            <button className="flex items-center justify-between text-[#F6941E] bg-white px-[16px] py-[11px] xxs:px-[10px] xxs:py-[8px] xxs:gap-x-[5px] gap-x-[10px] mt-6 border border-[#F6941E] font-bold text-[18px] leading-[23px]">
