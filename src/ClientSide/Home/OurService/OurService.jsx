  ...
  return (
    <div>
      ...
      "
       ...
       xs:text-[14px] xs:leading-[21px] pb-[10px] "
         ...
         xs:px-[24px] xs:py-[41px] text-center  border-b-[#F6941E] border-b-2 "
          >
            ...
            <h1
              className="text-[#F6941E]  pb-[10px] xs:pb-[10px] xl:pb-[10px]  lg:pb-[5px] md:pb-[5px]  font-bold font-helvetica 
       ...
       xs:text-[14px] xs:leading-[21px] pb-[10px]"
         ...
         xs:px-[24px] xs:py-[41px] text-center "
          >
            <div className="flex justify-center  mb-[15px] xs:mb-[15px]  xl:mb-[15px]  lg:mb-[15px] md:mb-[15px] xxs:mb-[10px]">
              <img
                className=""
      ...
      "
       ...
       xxs:text-[12px] xxs:leading-[18px]  xs:text-[14px] xs:leading-[21px] pb-[10px]"
        ...
        px-[24px] py-[41px] xxs:py-[10px] xs:px-[24px] xs:py-[41px] text-center border-b-[#F6941E] border-b-2 "
          >
            <div className="flex justify-center mb-[15px]  xs:mb-[15px]   xl:mb-[15px]  lg:mb-[15px] md:mb-[15px] xxs:mb-[10px] h-[50px]">
              <img
                className=""
                src="https://i.ibb.co/1ZgG4hD/frame-5-66d3e1293f306.webp"
                alt=""
            ...
            <h1
              className="text-[#F6941E]  pb-[10px] xs:pb-[10px] xl:pb-[10px]  lg:pb-[5px] md:pb-[5px] font-bold font-helvetica xl:text-[24px] xl:leading-[28px]
          2xl:text-[24px] 2xl:leading-[28px]
          lg:text-[20px] lg:leading-[28px]
    ...
    xxs:text-[12px] xxs:leading-[18px]      xs:text-[14px] xs:leading-[21px] pb-[10px]"
        ...
        px-[24px] py-[41px] xxs:py-[10px] xs:px-[24px] xs:py-[41px] text-center "
          ...
          xxs:text-[16px]
          xs:text-[28px] xs:leading-[24px] text-[#1E1E1E]"
            >
              Scholarship
            </h1>
            <p
     ...
     xxs:text-[12px] xxs:leading-[18px]     xs:text-[14px] xs:leading-[21px] pb-[10px]"
        ...
        px-[24px] py-[41px] xxs:py-[10px] xs:px-[24px] xs:py-[41px]  text-center"
          ...
          xxs:text-[16px]  xs:leading-[24px] text-[#1E1E1E]"
            >
              Easy Application
            </h1>
            <p
