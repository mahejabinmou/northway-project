        ...
        <div className="lg:hidden block mx-[39px]">
          <div className="grid  grid-cols-1 gap-x-[6px]">
            ...
            <div className="  text-center  ">
              ...
              xxs:text-[12px] xxs:leading-[23px] px-[69px] py-[23.5px]  bg-[#F6941E] text-white "
              >
                Course Duration
              </h3>
              <p className="pt-[31px] pl-[73px] pr-[63px] text-[16px] xs:text-[16px] pb-[10px] xxs:text-[10px]  ">
                4 Years (Bachelor’s)
              </p>
              <p className="pb-[31px] pl-[80px] pr-[70px] text-[16px] xs:text-[16px]  xxs:text-[10px] ">
                2 Years (Master’s)
              </p>
            </div>
            {/* intak */}
            <div className="  text-center ">
              ...
              xxs:text-[12px] xxs:leading-[23px] bg-[#F6941E] text-white"
              >
                Intake
              </h3>
              <p className="pt-[31px] pl-[95px] pr-[85px] pb-[10px] text-[16px] xs:text-[16px]  xxs:text-[10px]">
                January, May,{" "}
              </p>
              <p className="pb-[31px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                September
              </p>
            </div>
            {/* Application Fee */}
            <div className="  text-center ">
              ...
              <p className="py-[48px] pl-[85px] pr-[75px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                40 To 200 (USD)
              </p>
            </div>
            {/* Requirements */}
            <div className=" text-center">
              ...
              <p className="pt-[34px] pl-[40px] pr-[30px] font-normal font-helvetica text-[16px] xs:text-[16px] xxs:text-[10px] leading-[25.6px] pb-[1px]">
                GRE/GMAT + IELTS/TOEFL/
              </p>
              <p className="pb-[34px] pl-[40px] pr-[30px]  font-normal font-helvetica text-[16px] xs:text-[16px] xxs:text-[10px] leading-[25.6px]">
                PTE, Academics: Above 55%
              </p>
            </div>
            {/* Language Proficiency */}
            <div className=" text-center ">
              ...
              <p className="pt-[31px] pl-[63px] pr-[53px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                IELTS- 6+, TOEFL-70+
              </p>
              <p className="pt-[10px] pb-[31px] pl-[60.5px] pr-[50.5] text-[16px] xs:text-[16px] xxs:text-[10px]">
                Duolingo-90+, PTE-50+
              </p>
            </div>
            ...
            <div className=" text-center">
              ...
              xxs:text-[12px] xxs:leading-[23px]  bg-[#F6941E] text-white font-helvetica"
              >
                Tuition Fee (Yearly)
              </h3>
              <p className="py-[48px] pl-[63px] pr-[53px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                10000 To 55000 (USD)
              </p>
            </div>
            {/* Living Cost (Yearly) */}
            ...
            <div className=" text-center">
              ...
              <p
                className="py-[48px] pl-[63px] pr-[53px] font-normal text-[16px] xs:text-[16px] xxs:text-[10px]
            leading-[24px] "
              >
                10000 To 18000 (USD)
              </p>
            ...
            <div className=" text-center">
              ...
              <p className=" pt-[29px] pl-[40px] pr-[30px] font-normal font-helvetica text-[16px] xs:text-[16px] xxs:text-[10px] leading-[25.6px] pb-[10px]">
                160 (USD)
              </p>
              <p className="pb-[29.5px] pl-[40px] pr-[30px] font-normal font-helvetica text-[16px] xs:text-[16px] xxs:text-[10px] leading-[25.6px] ">
                SEVIS Fee 350 (USD)
              </p>
            </div>
            {/* Air Ticket */}
            <div className=" text-center">
              ...
              xxs:text-[8px] xxs:leading-[23px] bg-[#F6941E] text-white"
              >
                Air Ticket
              </h3>
              <p className="py-[41px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                100000 To 150000 (BDT)
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="pl-[20px] pr-[10px] py-[8px] text-[16px] xs:text-[16px] xxs:text-[10px]">
                12 Months for All Programs 12+ 24 Months Extension for STEM
                (Science, Tech, Engg & Maths)
              </p>
            </div>
