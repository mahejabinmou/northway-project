    ...
    <div>
      ...
      <div className="  relative">
        ...
        <div className="absolute  inset-0 mt-[40px] flex flex-col gap-y-[20px] px-[60px]  justify-center items-center  lg:px-[150px]   lg:text-left">
          ...
          <p className="font-normal font-helvetica 2xl:text-[8px] xs:text-[16px] leading-[24px]  2xl:max-w-[800px]  max-w-[550px]  text-center mx-auto md:text-xl 2xl:text-2xl lg:text-base text-white mt-2 lg:mt-0 ">
